...
```go
import "github.com/greenbone-hive/opensight-golang-libraries/pkg/retryableRequest"
```
...
## func [DeepCopyRequest](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/retryableRequest/retryableRequest.go#L71>)
...
## func [ExecuteRequestWithRetry](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/retryableRequest/retryableRequest.go#L23-L26>)
...
<a name="IsOk"></a>
## func [IsOk](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/retryableRequest/retryableRequest.go#L88>)
