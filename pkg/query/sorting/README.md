...
```go
import "github.com/greenbone-hive/opensight-golang-libraries/pkg/query/sorting"
```
...
<a name="AddRequest"></a>
## func [AddRequest](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/sorting.go#L36>)
...
## func [NewSortingError](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/error.go#L19>)
...
## func [ValidateSortingRequest](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/validate.go#L10>)
...
<a name="Error"></a>
## type [Error](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/error.go#L11-L13>)
...
### func \(\*Error\) [Error](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/error.go#L15>)
...
<a name="Params"></a>
## type [Params](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/params.go#L7-L11>)
...
### func [DetermineEffectiveSortingParams](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/sorting.go#L100>)
...
<a name="Request"></a>
## type [Request](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/request.go#L12-L15>)
...
<a name="Response"></a>
## type [Response](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/response.go#L10-L13>)
...
## type [SortDefault](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/sorting.go#L50-L53>)
...
### func [GetSortDefaults](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/sorting.go#L56>)
...
## type [SortDirection](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/direction.go#L33>)
...
### func [SortDirectionFromString](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/direction.go#L22>)
...
### func \(SortDirection\) [String](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/direction.go#L15>)
...
## type [SortableColumn](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/sorting.go#L44-L47>)
...
### func [GetSortableColumns](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/sorting.go#L61>)
...
## type [SortingSettingsInterface](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/sorting/sortingInterface.go#L7-L11>)
