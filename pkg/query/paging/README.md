...
```go
import "github.com/greenbone-hive/opensight-golang-libraries/pkg/query/paging"
```
...
<a name="AddRequest"></a>
## func [AddRequest](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/request.go#L24>)
...
## func [NewPagingError](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/error.go#L19>)
...
<a name="Error"></a>
## type [Error](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/error.go#L11-L13>)
...
### func \(\*Error\) [Error](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/error.go#L15>)
...
## type [PagingSettingsInterface](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/pagingInterface.go#L7-L9>)
...
<a name="Request"></a>
## type [Request](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/request.go#L11-L14>)
...
### func [ValidateAndApplyPagingRules](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/paging.go#L8>)
...
<a name="Response"></a>
## type [Response](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/response.go#L12-L17>)
...
### func [NewResponse](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/response.go#L19>)
...
### func [NewResponseWithTotalResults](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/query/paging/response.go#L31>)
