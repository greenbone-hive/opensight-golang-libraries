...
```go
import "github.com/greenbone-hive/opensight-golang-libraries/pkg/slices"
```
...
<a name="Contains"></a>
## func [Contains](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/slices/slices.go#L31>)
...
## func [ContainsLambda](<https://github.com/greenbone-hive/opensight-golang-libraries/blob/main/pkg/slices/slices.go#L15>)
