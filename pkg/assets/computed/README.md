...
```go
import "github.com/greenbone/opensight-golang-libraries/pkg/assets/computed"
```
...
<a name="All"></a>All is every canonical computed\-field name, for the discovery\-\>Computed bucket routing and drift checks.
